  ...
  return (
    <>
      ...
      <div className='flex-grow dark:bg-black'>
        <h1 className='text-black py-10 text-center text-3xl font-bold dark:bg-black dark:text-white'>About Us</h1>
        <p className='text-black text-lg px-20 py-5 dark:bg-black dark:text-white'>
